  ...
  getBottomComponents() {
    ...
    if(this.isRequired) {
       b.push(textComponent({
            ...
            content: text(this, 'dateError', "Une date est attendue pour cette question (si vous avez déjà indiqué une date, nen tenez pas compte de ce message, il va disparaître en remplissant les questions suivantes)."),
            className: "text-danger",
            })
        );
    }

import {  questionPools, _T, LanguageMap, ItemProps, ItemQuestion, BaseChoiceQuestion,
     ClientExpression as client, trans_text,  as_option,  MatrixRow, 
     markdownComponent,
...
import responses, {VisitMedicalServiceTypes } from "./responses";
...
export class TestBeforeMedicalVisit extends BaseChoiceQuestion {

    constructor(props: ItemProps) {
        super(props, 'Qcov20', 'single');
        this.setOptions({
            questionText: _T("weekly.Qcov20.text", "Did you do a Covid test before to visit a medical service"),
        });
    }
    ...
    getResponses(): OptionDef[] {
        ...
        return [
            option_def('1', _T('weekly.Qcov20.option.1', "Yes, it was negative")),
            option_def('2', _T('weekly.Qcov20.option.2', "Yes, it was positive")),
            option_def('3', _T('weekly.Qcov20.option.3', "Yes, result is not known or not interpretable")),
            option_def('4', _T('weekly.Qcov20.option.4', "No")),
            option_def('99',_T('weekly.Qcov20.option.dnk','I dont remember / I dont know')),
        ];
    }
